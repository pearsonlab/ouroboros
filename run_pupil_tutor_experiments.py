...
def run_experiments(data_path='',model_path='',seed=92):
    ...
    if os.path.isfile(os.path.join(model_path,'eval_data.pkl')):
        ...
        pupil_tutor_r2s,pupil_tutor_best,pupil_tutor_resids,pupil_tutor_spec_ratio,pupil_tutor_specs,pupil_tutor_ext = full_eval_model(pupil_tutor_model,dls,audios,1/sr,use_results=False,\
                        n_int=50,plot_dir=model_path,plot_steps=False)
        
        pupil_tutor_eval_dict={'r2s':pupil_tutor_r2s,
